...
class ImageServiceTest {
	...
	void 새소식_이미지_저장_성공() {
		// when
		imageService.createImages(TEST_NEWSFEED, List.of("file1.jpg", "file2.jpg"), 0);
	...
	void 상품_이미지_조회_성공() {
		...
		// then
		assertEquals(List.of("file1.jpg", "file2.jpg"), dto.getImageUrls());
	...
	void 새소식_이미지_조회_성공() {
		// given
		List<Image> existingimages = List.of(
			Image.of(TEST_NEWSFEED, "file1.jpg", true),
			Image.of(TEST_NEWSFEED, "file2.jpg", false));
	...
	void 새소식_이미지_수정_이미지삭제_성공() {
		...
		List<Image> newimages = List.of(Image.of(TEST_NEWSFEED, "file1.jpg", true));
		...
		// when
		imageService.updateImages(TEST_NEWSFEED, List.of("file1.jpg"), 0);
	...
	void 새소식_이미지_수정_이미지저장_성공() {
		// given
		List<Image> existingimages = List.of(Image.of(TEST_NEWSFEED, "file1.jpg", true));
		...
		// when
		imageService.updateImages(TEST_NEWSFEED, List.of("file1.jpg", "file2.jpg"), 0);
	...
	void 새소식_이미지_수정_대표이미지변경_성공() {
		Image image1 = spy(Image.of(TEST_NEWSFEED, "file1.jpg", true));
		Image image2 = spy(Image.of(TEST_NEWSFEED, "file2.jpg", false));
		...
		// when
		imageService.updateImages(TEST_NEWSFEED, List.of("file1.jpg", "file2.jpg"), 1);
	...
	void 새소식_이미지_삭제_성공() {
		// given
		List<Image> images = List.of(Image.of(TEST_NEWSFEED, "file1.jpg", true));
